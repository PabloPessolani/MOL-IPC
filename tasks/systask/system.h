...
_PROTOTYPE( int do_rexec, (message *m_ptr) );
#if ! USE_REXEC
#define do_rexec do_unused
#endif
...
_PROTOTYPE( int do_dc_setbuf, (message *m_ptr) );
_PROTOTYPE( int do_dc_map, (message *m_ptr) );
...
_PROTOTYPE( int do_killed, (message *m_ptr) );
#if ! USE_KILLED
#define do_killed do_unused
#endif

_PROTOTYPE( int do_bindproc, (message *m_ptr) );
#if ! USE_BINDPROC
#define do_bindproc do_unused
#endif

_PROTOTYPE( int do_migrproc, (message *m_ptr) );
#if ! USE_MIGRPROC
#define do_migrproc do_unused
#endif

_PROTOTYPE( int do_setpname, (message *m_ptr) );
#if ! USE_SETPNAME
#define do_setpname do_unused
#endif

_PROTOTYPE( int do_iopenable, (message *m_ptr) );	


_PROTOTYPE( int do_unbind, (message *m_ptr) );
#if ! USE_UNBIND
#define do_unbind do_unused
#endif
