...
/*fin de la copia del main de FS () donde carga la imagen*/
 ...
 sa.sa_handler = SIG_MESS;
  ...
  m_init();	//fs_init(vmid); en file system		lo q hago en load_image- bind de esta tarea - lo anterior comentar no +
  driver_task(&m_dtab);		
...
/*copio código de load_image () similar a lo hecho para FS*/
