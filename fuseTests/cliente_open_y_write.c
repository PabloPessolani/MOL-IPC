...
void  main ( int argc, char *argv[] )
{
	...
	if ( argc != 7)
	{
		printf( "Usage: %s <vmid> <clt_nr> <svr_nr> <path> <textoAEscribir> <tipoMensaje M1=1 o M3=3> \n", argv[0] );
		exit(1);
	}
	...
	if ( tipoMensaje == M1) {
		...
		m.m1_i2 = O_RDWR|O_EXCL; //flags posibles MODOS de APERTURA para OPEN. Aqui deberia ser O_CREAT para tipo M1 porque en posix esta asiv
		...
		m.m3_p1 = path;
		m.m3_i2 = O_RDWR; //para lectura/escritura tipo M3
    ...
    printf("REPLY WRITE msg: m_source=%d, m_type=%d, m1_i1=%d, m1_i2=%d, m1_p1=%p\n",
    	m.m_source,
    	m.m_type,
    	m.m1_i1,
    	m.m1_i2,
