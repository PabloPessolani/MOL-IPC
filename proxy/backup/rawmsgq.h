...
#define RAW_WAIT4MSGQ 		2 
#define RAW_MQ_BASE			4000
#define RAW_WAIT4ETH		10
#define RAW_FRAMES2WAIT 	10
  
enum raw_flags {
		RAW_VOID 	= 0x00,
		RAW_DATA	= 0x01,	// the frame payload is data 
		RAW_EOF		= 0x02, // end of file 
		RAW_EOB		= 0x04, // end of block
		RAW_RESEND  = 0x08, // this frame is a retransmition 
		RAW_NEEDACK = 0x10, // this frame needs ACK 
		RAW_CANCEL  = 0x20, // Cancel the complete data block
		RAW_BADSEQ  = 0x40, // bad sequence number 
  };
