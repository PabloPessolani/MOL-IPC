...
./demonize -l $lcl $dcid 20 0 "/home/MoL_Module/mol-ipc/commands/m3urlget/websrv /home/MoL_Module/mol-ipc/commands/m3urlget/websrv.cfg"  > websrvout.txt 2> websrverr.txt &
sleep 2
cat /proc/dvs/DC$dcid/procs
####################### START WEBCLT on NODE1 #################
read  -p "Starting WEBCLT on NODE1. Enter para continuar... "
dmesg -c  >> /home/MoL_Module/mol-ipc/dmesg$lcl.txt
cd /home/MoL_Module/mol-ipc/commands/demonize
./demonize -l $rmt $dcid 21 0 "/home/MoL_Module/mol-ipc/commands/m3urlget/webclt file10M.txt"  > webcltout.txt 2> webclterr.txt &
sleep 2
####################### START WEBCLT on NODE1 #################
read  -p "Starting WEBCLT on NODE1. Enter para continuar... "
dmesg -c  >> /home/MoL_Module/mol-ipc/dmesg$lcl.txt
cd /home/MoL_Module/mol-ipc/commands/demonize
./demonize -l $rmt $dcid 22 0 "/home/MoL_Module/mol-ipc/commands/m3urlget/webclt file50M.txt"  > webcltout.txt 2> webclterr.txt &
sleep 2
dmesg -c  >> /home/MoL_Module/mol-ipc/dmesg$lcl.txt
echo "this program get /lib/init/rw/nweb/file50M.txt &  file10M.txt from websvr"
echo " the result is wrote in file50M.txt and file10M.txt of task/systask/ on NODE1"
echo " performance result is wrote in task/systask/results.txt of NODE1"
cat /proc/dvs/DC$dcid/procs
exit
