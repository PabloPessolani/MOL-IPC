...
/home/jara/mol-ipc/tests/test_drvs_init  -n 2 -D 0
# -D 520966
...
then 
	...
	/home/jara/mol-ipc/proxy/uproxy node1 1 >node1.txt 2>error2.txt &
else
	/home/jara/mol-ipc/proxy/tproxy node0 0 >node0.txt 2>error0.txt &
	/home/jara/mol-ipc/proxy/tproxy node1 1 >node1.txt 2>error2.txt &
fi
cat /proc/drvs/nodes
cat /proc/drvs/proxies
sleep 10
read  -p "Enter para continuar... "
