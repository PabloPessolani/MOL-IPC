...
void  main ( int argc, char *argv[] )
{
    ...
    m.m2_i1 = RAM_DEV; //A VER SI LO ENVÍO COMO PARÁMETRO 
	printf("DEV_GATHER - DEVICE: m_m2_i1=%d\n", m.m2_i1);
	
    m.m2_i2 = proc_nr; //process doing the request (usado en memory.c)
	printf("DEV_GATHER: m_m2_i2=%d\n", m.m2_i2);
	
	//off_t position;			/* offset on device to read or write */
	//puede ser q off_t esté typedef unsigned long  mnx_off_t;	???   /* offset within a file */
	
	m.m2_l1 = position;
	printf("DEV_GATHER - offset: m_m2_l1=%u\n", m.m2_l1);
	...
	m.m2_l2 = count;
    m.m2_p1 = iov; /*puntero al vecotr iovec*/ 

	printf("SENDREC msg GATHER: m_type=%d, m2_i1=%d, m2_i2=%d, m2_l1=%u, m2_l2=%u, m2_p1=%p\n",
           m.m_type,
           m.m2_i1,
           m.m2_i2,
		   m.m2_l1,
