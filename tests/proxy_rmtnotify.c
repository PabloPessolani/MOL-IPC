...
#define	MAXBUF	(sizeof(proxy_hdr_t) - sizeof(int))
...
void  main ( int argc, char *argv[] )
{
	...
	/*REPLY WITH CMD_NTFY_MSG */
		/* BUILD THE REPLY HEADER */
		buf_out.header.c_cmd 	= CMD_NTFY_MSG;
