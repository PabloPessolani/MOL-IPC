...
typedef int  (*sr_open_t) ( int port, int srfd,
...
typedef int (*sr_read_t) ( int fd, mnx_size_t count );
typedef int (*sr_write_t) ( int fd, mnx_size_t count );
...
void sr_init ( void  );
void sr_add_minor ( int minor, int port, sr_open_t openf,
