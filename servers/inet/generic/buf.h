...
#else
acc_t *_bf_memreq ( char *clnt_file, int clnt_line,
			unsigned size);
#endif
...
#else
acc_t *_bf_dupacc ( char *clnt_file, int clnt_line,
			acc_t *acc );
#endif
...
#else
void _bf_afree ( char *clnt_file, int clnt_line,
			acc_t *acc);
#endif
...
#else
acc_t *_bf_pack ( char *clnt_file, int clnt_line,
			acc_t *pack);
#endif
...
#else
acc_t *_bf_packIffLess ( char *clnt_file, int clnt_line,
				acc_t *pack, int min_len );
#endif
/* this performs a bf_pack iff pack->acc_length<min_len */

mnx_size_t bf_bufsize ( acc_t *pack);
...
#else
acc_t *_bf_cut ( char *clnt_file, int clnt_line,
...
#else
acc_t *_bf_delhead ( char *clnt_file, int clnt_line,
...
#else
acc_t *_bf_append ( char *clnt_file, int clnt_line,
...
#ifndef BUF_TRACK_ALLOC_FREE
acc_t *bf_align ( acc_t *acc, mnx_size_t size, mnx_size_t alignment );
#else
acc_t *_bf_align ( char *clnt_file, int clnt_line,
			acc_t *acc, mnx_size_t size, mnx_size_t alignment );
#endif
