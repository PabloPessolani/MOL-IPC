...
#define ETH_FORMAT "etp_flags=%X etp_port=%d etp_ethaddr=%02X:%02X:%02X:%02X:%02X:%02X\n"
#define ETH_FIELDS(p) 	p->etp_flags,p->etp_osdep.etp_port,p->etp_ethaddr.ea_addr[0]\
						, p->etp_ethaddr.ea_addr[1],p->etp_ethaddr.ea_addr[2]\
						, p->etp_ethaddr.ea_addr[3],p->etp_ethaddr.ea_addr[4],p->etp_ethaddr.ea_addr[5]
...
void eth_arrive( eth_port_t *port, acc_t *pack, mnx_size_t pack_size );
