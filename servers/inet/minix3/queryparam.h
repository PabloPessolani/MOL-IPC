...
struct export_param_list {
	...
	mnx_size_t	size;		/* Size of the resulting object. */
};
...
int queryparam(int (*_qgetc)(void), void **_paddress, mnx_size_t *_psize);
mnx_size_t paramvalue(char **_value, void *_address, mnx_size_t _size);
