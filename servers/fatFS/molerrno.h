...
#define EMOLDCNODE 	(_SIGN 326)  /* The NODE is ALLREADY included into the DC list of nodes */
#define EMOLBADPROXY (_SIGN 327)  /* The NODE is ALLREADY included into the DC list of nodes */
