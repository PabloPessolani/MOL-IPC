...
/home/jara/mol-ipc/tests/test_drvs_init -n 0 -D 0
# 16777215
/home/jara/mol-ipc/tests/test_vm_init -v 0
read  -p "Enter para continuar... "
if [ $1 == "u" ] 
then 
	/home/jara/mol-ipc/proxy/uproxy node1 1 >node1.txt 2>error1.txt &
	/home/jara/mol-ipc/proxy/uproxy node2 2 >node2.txt 2>error2.txt &
elif  [ $1 == "t" ]
then 
	/home/jara/mol-ipc/proxy/tproxy node1 1 >node1.txt 2>error1.txt &
	/home/jara/mol-ipc/proxy/tproxy node2 2 >node2.txt 2>error2.txt &
else
	tipc-config -net=4711 -a=1.1.100 -be=eth:eth0
	/home/jara/mol-ipc/proxy/tipcproxy node1 1 >node1.txt 2>error1.txt &
...
read  -p "Enter para continuar... "
/home/jara/mol-ipc/tests/test_add_node 0 1
#/home/jara/mol-ipc/tests/test_add_node 0 2
cat /proc/drvs/VM0/info
read  -p "Enter para continuar... "
/home/jara/mol-ipc/tests/test_rmtbind 0 1 1
