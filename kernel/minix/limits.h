...
//--------------------------------------------------------------------------------------
//		W A R N I N G
// Si hace falta incluir alguna de estas constantes, hay conflicto con LINUX
// poner MNX_XXXXXX para diferenciar
//--------------------------------------------------------------------------------------
...
#define MNX_PATH_MAX        255	/* # chars in a path name */
#define	MNX_MAX_ARGS		10	/* # of arguments (argc) of rexec */ 
#define MNX_OPEN_MAX        30	/* # open files a process may have */
