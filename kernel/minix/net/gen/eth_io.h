...
{
	u32_t nweo_flags;
	mnx_ethaddr_t nweo_multi, nweo_rem;
...
{
	mnx_ethaddr_t nwes_addr;
	eth_stat_t nwes_stat;
} nwio_ethstat_t;

#define NWES_FORMAT "ethaddr=%02X:%02X:%02X:%02X:%02X:%02X\n"
#define NWES_FIELDS(p)  p->nwes_addr.ea_addr[0]	, p->nwes_addr.ea_addr[1],p->nwes_addr.ea_addr[2]\
						, p->nwes_addr.ea_addr[3],p->nwes_addr.ea_addr[4],p->nwes_addr.ea_addr[5]
