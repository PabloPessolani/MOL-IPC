...
#define IPHDR_FORMAT 		"vers=%X tos=%X len=%X id=%X flag=%X ttl=%X proto=%X chk=%X src=%lX dst=%lX\n"
#define IPHDR_FIELDS(p) 	p->ih_vers_ihl, p->ih_tos, p->ih_length, p->ih_id, \
							p->ih_flags_fragoff, p->ih_ttl, p->ih_proto, p->ih_hdr_chk, \
							p->ih_src, p->ih_dst
