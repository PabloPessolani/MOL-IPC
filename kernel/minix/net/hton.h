...
#define MNX_LITTLE_ENDIAN	1
#endif

#if (_MINIX_CHIP == _CHIP_M68000 || _MINIX_CHIP == _CHIP_SPARC)
#define MNX_BIG_ENDIAN	1
#endif

#if (MNX_LITTLE_ENDIAN) && (MNX_BIG_ENDIAN)
#include "both MNX_LITTLE_ENDIAN and MNX_BIG_ENDIAN are defined"
			/* MNX_LITTLE_ENDIAN and MNX_BIG_ENDIAN are both defined */
#endif

#if !(MNX_LITTLE_ENDIAN) && !(MNX_BIG_ENDIAN)
#include "neither MNX_LITTLE_ENDIAN nor MNX_BIG_ENDIAN is defined"
			/* MNX_LITTLE_ENDIAN and MNX_BIG_ENDIAN are both NOT defined */
#endif

#if MNX_LITTLE_ENDIAN
