...
struct fuse_lowlevel_ops {
	 ...
	 * @param fi file information
	 */
	void (*read) (fuse_req_t req, fuse_ino_t ino, mnx_size_t size, off_t off,
		      struct fuse_file_info *fi);
	...
	void (*write) (fuse_req_t req, fuse_ino_t ino, const char *buf,
		       mnx_size_t size, off_t off, struct fuse_file_info *fi);
	 ...
	 * @param fi file information
	 */
	void (*readdir) (fuse_req_t req, fuse_ino_t ino, mnx_size_t size, off_t off,
			 struct fuse_file_info *fi);
	...
	void (*setxattr) (fuse_req_t req, fuse_ino_t ino, const char *name,
			  const char *value, mnx_size_t size, int flags);
	 ...
	 */
	void (*listxattr) (fuse_req_t req, fuse_ino_t ino, mnx_size_t size);
	 ...
	 */
	void (*bmap) (fuse_req_t req, fuse_ino_t ino, mnx_size_t blocksize,
		      uint64_t idx);
	...
	void (*ioctl) (fuse_req_t req, fuse_ino_t ino, int cmd, void *arg,
		       ...
		       const void *in_buf, mnx_size_t in_bufsz, mnx_size_t out_bufsz);
	 ...
	 * @param req request handle
	 */
	void (*forget_multi) (fuse_req_t req, mnx_size_t count,
 ...
 * @return zero for success, -errno for failure to send reply
 */
int fuse_reply_write(fuse_req_t req, mnx_size_t count);
 ...
 * @return zero for success, -errno for failure to send reply
 */
int fuse_reply_buf(fuse_req_t req, const char *buf, mnx_size_t size);
 ...
 * @return zero for success, -errno for failure to send reply
 */
int fuse_reply_xattr(fuse_req_t req, mnx_size_t count);
 ...
 */
mnx_size_t fuse_add_direntry(fuse_req_t req, char *buf, mnx_size_t bufsize,
...
int fuse_reply_ioctl_retry(fuse_req_t req,
			   const struct iovec *in_iov, mnx_size_t in_count,
			   const struct iovec *out_iov, mnx_size_t out_count);
 ...
 */
int fuse_reply_ioctl(fuse_req_t req, int result, const void *buf, mnx_size_t size);
...
int fuse_lowlevel_notify_inval_entry(struct fuse_chan *ch, fuse_ino_t parent,
                                     const char *name, mnx_size_t namelen);
...
int fuse_lowlevel_notify_retrieve(struct fuse_chan *ch, fuse_ino_t ino,
				  mnx_size_t size, off_t offset, void *cookie);
...
struct fuse_session *fuse_lowlevel_new(struct fuse_args *args,
				       ...
				       mnx_size_t op_size, void *userdata);
...
struct fuse_session_ops {
	 ...
	 */
	void (*process) (void *data, const char *buf, mnx_size_t len,
			 struct fuse_chan *ch);
 ...
 * @param ch channel on which the request was received
 */
void fuse_session_process(struct fuse_session *se, const char *buf, mnx_size_t len,
			  struct fuse_chan *ch);
...
struct fuse_chan_ops {
	 ...
	 */
	int (*receive)(struct fuse_chan **chp, char *buf, mnx_size_t size);
 ...
 */
mnx_size_t fuse_chan_bufsize(struct fuse_chan *ch);
 ...
 * @return the actual size of the raw request, or -errno on error
 */
int fuse_chan_recv(struct fuse_chan **ch, char *buf, mnx_size_t size);
