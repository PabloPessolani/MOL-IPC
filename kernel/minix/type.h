...
#define 	VIRCP_FORMAT "src_e=%d src_off=%X dst_e=%d dst_off=%X count=%d\n"
#define 	VIRCP_FIELDS(p) p->src.proc_nr_e, p->src.offset,p->dst.proc_nr_e, p->dst.offset, p->count 
