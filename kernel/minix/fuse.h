...
struct fuse_operations {
	 ...
	 * for success.
	 */
	int (*readlink) (const char *, char *, mnx_size_t);
	 ...
	 * Changed in version 2.2
	 */
	int (*read) (const char *, char *, mnx_size_t, off_t,
	 ...
	 * Changed in version 2.2
	 */
	int (*write) (const char *, const char *, mnx_size_t, off_t,
		      struct fuse_file_info *);
	...
	int (*setxattr) (const char *, const char *, const char *, mnx_size_t, int);

	/** Get extended attributes */
	int (*getxattr) (const char *, const char *, char *, mnx_size_t);

	/** List extended attributes */
	int (*listxattr) (const char *, char *, mnx_size_t);
	 ...
	 * Introduced in version 2.6
	 */
	int (*bmap) (const char *, mnx_size_t blocksize, uint64_t *idx);
	...
	int (*read_buf) (const char *, struct fuse_bufvec **bufp,
			 mnx_size_t size, off_t off, struct fuse_file_info *);
	/**
...
struct fuse *fuse_new(struct fuse_chan *ch, struct fuse_args *args,
		      const struct fuse_operations *op, mnx_size_t op_size,
		      void *user_data);
...
int fuse_main_real(int argc, char *argv[], const struct fuse_operations *op,
		   mnx_size_t op_size, void *user_data);
...
int fuse_fs_open(struct fuse_fs *fs, const char *path,
		 struct fuse_file_info *fi);
int fuse_fs_read(struct fuse_fs *fs, const char *path, char *buf, mnx_size_t size,
		 off_t off, struct fuse_file_info *fi);
int fuse_fs_read_buf(struct fuse_fs *fs, const char *path,
		     struct fuse_bufvec **bufp, mnx_size_t size, off_t off,
		     struct fuse_file_info *fi);
...
int fuse_fs_getxattr(struct fuse_fs *fs, const char *path, const char *name,
		     char *value, mnx_size_t size);
int fuse_fs_listxattr(struct fuse_fs *fs, const char *path, char *list,
		      mnx_size_t size);
int fuse_fs_removexattr(struct fuse_fs *fs, const char *path,
			const char *name);
int fuse_fs_bmap(struct fuse_fs *fs, const char *path, mnx_size_t blocksize,
		 uint64_t *idx);
 ...
 */
struct fuse_fs *fuse_fs_new(const struct fuse_operations *op, mnx_size_t op_size,
			    void *user_data);
