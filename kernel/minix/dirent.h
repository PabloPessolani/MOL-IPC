...
#define FLDIR_FORMAT "d_ino=%d d_extent=%u d_name=%s \n"

#define FLDIR_FIELDS(d) d->d_ino, d->d_extent, d->d_name
...
#define V7_FORMAT "d_ino=%d d_name=%s \n"

#define V7_FIELDS(d) d->d_ino, d->d_name
...
#define DIR_FORMAT "_fd=%c _v7=%c _count=%d _pos=%d \n"

#define DIR_FIELDS(d) d->_fd, d->_v7, d->_count, d->_pos
...
#define DIRENT_FORMAT "d_ino=%d d_extent=%u d_name=%s \n"

#define DIRENT_FIELDS(d) d->d_ino, d->d_extent, d->d_name
