...
#define EMOLBADDCID 	(_SIGN 302)  /* Bad DC ID */
#define EMOLDCNOTRUN 	(_SIGN 303)  /* The DC is not running */
...
#define EMOLDVSBUSY 	(_SIGN 317)  /* The DVS is BUSY - Can't assign new local node ID */
#define EMOLDVSINIT 	(_SIGN 318)  /* The DVS has not been initialized */
#define EMOLNODCNODE 	(_SIGN 319)  /* The NODE is not included into the DC list of nodes */
...
#define EMOLDCRUN 	(_SIGN 323)  /* The DC is already running */
#define EMOLPROCSTS (_SIGN 324)  	/* Bad process status  */
#define EMOLNODEFREE (_SIGN 325)  /* NODE is FREE */
#define EMOLDCNODE 	(_SIGN 326)  /* The NODE is ALREADY included into the DC list of nodes */
#define EMOLBADPROXY (_SIGN 327)  /* The NODE is ALREADY included into the DC list of nodes */
...
#define EMOLPROXYID	 	 (_SIGN 345)  	/* Bad PROXY PAIR ID */
#define EMOLREPLPROC 	 (_SIGN 346)  	/* The process is REPLICATED */
#define EMOLALIGN  		 (_SIGN 347)  	/* Addresses not aligned */
#define EMOLWOKENUP	 	(_SIGN 348)  		/* A waiting process has beenb woken up by other process */

/* Errors related to REPLICATION */
#define EMOLPRIMARY		(_SIGN 401)	 /* There is no PRIMARY member */			
#define EMOLNOREPLICA	(_SIGN 402)	 /* There is no Replica members */			
